...
export class LoanApplyService {
  ...
  getLoanApplyList(req:any, callback:any){
    const ENDPOINT = `${environment.BASE_URL}/api/getLoanApplyListByFA`;
  ...
  checkAcCount(req:any, callback:any) {
    const ENDPOINT = `${environment.BASE_URL}/api/checkAcCount`;
    const requestOptions = {
      headers: this.appService.headers,
      method: 'post',
      requestObject: req
  ...
  createLoan(req: any, callback: any) {
    const ENDPOINT = `${environment.BASE_URL}/api/createLoan`;
    const requestOptions = {
      headers: this.appService.headers,
      method: "post",
      requestObject: req
  ...
  finaLoanSave(req: any, callback: any) {
    const ENDPOINT = `${environment.BASE_URL}/api/finaLoanSave`;
    const requestOptions = {
      headers: this.appService.headers,
      method: "post",
      requestObject: req
