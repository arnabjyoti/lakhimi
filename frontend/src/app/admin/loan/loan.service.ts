...
export class LoanService {
  ...
  getLoanApplyListMD(req:any, callback:any){
    const ENDPOINT = `${environment.BASE_URL}/api/getLoanApplyListHOByMD`;
    const requestOptions = {
      headers: this.appService.headers,
      method: "post",
      requestObject: req
  ...
  getLoanApplyListCM(req:any, callback:any){
    const ENDPOINT = `${environment.BASE_URL}/api/getLoanApplyListHOByCM`;
    const requestOptions = {
      headers: this.appService.headers,
      method: "post",
      requestObject: req
